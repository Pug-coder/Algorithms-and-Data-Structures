...
func search(node *html.Node) []*Item {
	if isDiv(node, "product_data__gtm-js product_data__pageevents-js ProductCardHorizontal js--ProductCardInListing js--ProductCardInWishlist") {
		var items []*Item
		for c := node.FirstChild; c != nil; c = c.NextSibling {
			if isDiv(c, "ProductCardHorizontal__header-block") {
